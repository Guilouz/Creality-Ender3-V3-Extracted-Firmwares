...
class SoftHomingInit:
    ...
    def __init__(self, config):
        ...
        gcode.register_command('SOFT_CHECK_ERROR', self.cmd_SOFT_G28_CHECK_ERROR)
        ...
        self.diff_step = config.getint('diff_step', default=2, minval=1, maxval=50)
    ...
    def ck_and_raise_error(self, err_code, vals=[]): 
        ...
        pass
    def cmd_SOFT_G28_CHECK_ERROR(self, gcmd):
